...
public class PlainView extends View implements TabExpander {
    ...
    public void insertUpdate(DocumentEvent changes, Shape a, ViewFactory f) {
        System.err.println("src plain view update p0");
	updateDamage(changes, a, f);
        System.err.println("src plain view update p1");
    }
    ...
    protected void updateDamage(DocumentEvent changes, Shape a, ViewFactory f) {
        System.err.println("src plain view damage p0");
	Component host = getContainer();
	updateMetrics();
	...
	if (((added != null) && (added.length > 0)) || 
        ...
        System.err.println("src plain view damage p1");
	    ...
	    host.repaint();
            ...
            System.err.println("src plain view damage p2a");
	    Element map = getElement();
	    int line = map.getElementIndex(changes.getOffset());
	    damageLineRange(line, line, a, host);
	    if (changes.getType() == DocumentEvent.EventType.INSERT) {
                System.err.println("src plain view damage p2b");
		// check to see if the line is longer than current
		// longest line.
		int w = getLineWidth(longLine);
		Element e = map.getElement(line);
                System.err.println("src plain view damage p2c");
		if (e == longLine) {
                System.err.println("src plain view damage p2d");
		    preferenceChanged(null, true, false);
                System.err.println("src plain view damage p2e");
		} else if (getLineWidth(e) > w) {
                System.err.println("src plain view damage p2f");
		    longLine = e;
		    preferenceChanged(null, true, false);
		}
        ...
        System.err.println("src plain view damage done");
    }
