...
public abstract class View implements SwingConstants {
	...
	this.elem = elem;
        System.err.println("src view construct");
    }
    ...
    public void preferenceChanged(View child, boolean width, boolean height) {
        System.err.println("src prefChange p0");
	View parent = getParent();
        System.err.println("src prefChange p1");
	if (parent != null) {
            System.err.println("src prefChange p2");
            System.err.println("parent = " + parent.toString());
            System.err.println("this   = " + this.toString());
            if(this instanceof FieldView) return;  //SMCook
	    parent.preferenceChanged(this, width, height);
            System.err.println("src prefChange p3");
	}
        System.err.println("src prefChange p4");
    }
    ...
    public void insertUpdate(DocumentEvent e, Shape a, ViewFactory f) {
        System.err.println("src view p0");
	if (getViewCount() > 0) {
	    Element elem = getElement();
	    DocumentEvent.ElementChange ec = e.getChange(elem);
	    if (ec != null) {
                System.err.println("src view p1");
		if (! updateChildren(ec, e, f)) {
            ...
            System.err.println("src view p2");
	    forwardUpdate(ec, e, a, f);
            System.err.println("src view p3");
	    updateLayout(ec, e, a);
            System.err.println("src view p4");
	}
        System.err.println("src view p5");
    }
