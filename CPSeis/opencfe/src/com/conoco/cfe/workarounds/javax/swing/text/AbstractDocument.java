...
/* import sun.awt.font.BidiUtils;  kpg - jdk1.5 change */
...
public abstract class AbstractDocument implements Document, Serializable {
    ...
    protected void fireInsertUpdate(DocumentEvent e) {
        ...
        try {
            ...
            //System.err.println("src fire listeners.length = " + listeners.length);
            for (int i = listeners.length-2; i>=0; i-=2) {
                //System.err.println("src fire i = " + i);
                if (listeners[i]==DocumentListener.class) {
                    // Lazily create the event:
                    // if (e == null)
                    // e = new ListSelectionEvent(this, firstIndex, lastIndex);
                    //System.err.println("src fire 2a");
                    //System.err.println("src listener: " + listeners[i+1].toString());
                    ((DocumentListener)listeners[i+1]).insertUpdate(e);
                    //System.err.println("src fire 2b");
                }
            }
        } finally {
            //System.err.println("src fire 3");
            notifyingListeners = false;
        }
        //System.err.println("src fire end");
    }
    ...
    public void replace(int offset, int length, String text,
        ...
        //System.err.println("src replace p0");
        if (length == 0 && (text == null || text.length() == 0)) {
            //System.err.println("src replace p1");
            return;
        }
        DocumentFilter filter = getDocumentFilter();

        //System.err.println("src replace p2");
	writeLock();
	try {
            if (filter != null) {
                //System.err.println("src replace p2a");
                filter.replace(getFilterBypass(), offset, length, text,
                               attrs);
            }
            else {
                //System.err.println("src replace p2b");
                remove(offset, length);
                //System.err.println("src replace p2c");
                insertString(offset, text, attrs);
                //System.err.println("src replace p2d");
            }
        } finally {
            //System.err.println("src replace p3");
            writeUnlock();
        }
        //System.err.println("src replace p4");
    }
    ...
    public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
        //System.err.println("src insertString 1");
	...
	writeLock();
        //System.err.println("src insertString 2");
	try {
            if (filter != null) {
                //System.err.println("src insertString 3");
                filter.insertString(getFilterBypass(), offs, str, a);
            }
            else {
                //System.err.println("src insertString 4a");
                handleInsertString(offs, str, a);
                //System.err.println("src insertString 4b");
            }
        } finally {
            //System.err.println("src insertString 5");
            writeUnlock();
        }
        //System.err.println("src insertString 6");
    }
    ...
    void handleInsertString(int offs, String str, AttributeSet a)
        ...
        //System.err.println("src handleInsertString 1");
        if ((str == null) || (str.length() == 0)) {
            //System.err.println("src handleInsertString 2");
	    return;
	}
        //System.err.println("src handleInsertString 3");
        UndoableEdit u = data.insertString(offs, str);
        //System.err.println("src handleInsertString 4");
        DefaultDocumentEvent e = 
        ...
        if( getProperty(I18NProperty).equals( Boolean.FALSE ) ) {
            //System.err.println("src handleInsertString 5");
        ...
        //System.err.println("src handleInsertString 6");
        insertUpdate(e, a);
        //System.err.println("src handleInsertString 6a");
        // Mark the edit as done.
        e.end();
        //System.err.println("src handleInsertString 6b");
        fireInsertUpdate(e);
        //System.err.println("src handleInsertString 6c");
        // only fire undo if Content implementation supports it
        // undo for the composed text is not supported for now
        if (u != null && 
        ...
        //System.err.println("src handleInsertString 7");
    }
	...
	try {
            //System.err.println("src numReaders 1 = " + numReaders);
	    while ((numReaders > 0) || (currWriter != null)) {
                //System.err.println("src numReaders 2");
		if (Thread.currentThread() == currWriter) {
                    //System.err.println("src numReaders 3");
                    if (notifyingListeners) {
                        //System.err.println("src numReaders 4");
                    ...
                    numWriters++;
                    //System.err.println("src writeLock returning 1");
                    return;
                }
                //System.err.println("src wait p0");
		wait();
                //System.err.println("src wait p1");
	    }
	    currWriter = Thread.currentThread();
            numWriters = 1;
	} catch (InterruptedException e) {
            //System.err.println("src interrupted");
	    throw new Error("Interrupted attempt to aquire write lock");
	}
        //System.err.println("src writeLock returning 2");
    }
    ...
    protected synchronized final void writeUnlock() {
        //System.err.println("src numWriters = " + numWriters);
        if (--numWriters <= 0) {
            numWriters = 0;
            currWriter = null;
            //System.err.println("src notifying all");
            notifyAll();
        }
        //System.err.println("src writeUnlock returning");
    }
