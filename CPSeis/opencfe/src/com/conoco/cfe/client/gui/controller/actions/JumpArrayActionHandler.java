...
/**
 * Action handler for the "JumpArray" action.
 */
public class JumpArrayActionHandler
   ...
   */
  public JumpArrayActionHandler(AppGUIController.ActionHandlerHelper helper) {
    super(helper);  
  }
  ...
  public void performAction(Node n) {
    ...
    if (control != null) {
      ...
      //Console.logMessage("JumpArrayActionHandler: Couldn't find component " + keyword);
    }
  }        
