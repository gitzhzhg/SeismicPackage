// SensitiveArraySetActionHandler.java
...
/**
 * Action handler for the "SensitiveArraySet" action.
 */
public class SensitiveArraySetActionHandler
   ...
   */
  public SensitiveArraySetActionHandler(AppGUIController.ActionHandlerHelper helper) {
    super(helper);  
  }
  ...
  public void performAction(Node n) {
    ...
    if (control != null) {
      ...
      //Console.logMessage("SensitiveArraySetActionHandler: Couldn't find component " + keyword);
    }
  }        
}
