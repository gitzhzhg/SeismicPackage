 ...
 * labels.
 */
public class MultiLineLabelButtonUI extends MetalButtonUI {
  private final static MultiLineLabelButtonUI ui = 
                        new MultiLineLabelButtonUI(); 
...
//dkv     uiImpl.paintFocus(g,b,paintViewR,paintTextR,paintIconR, getFocusColor());
    uiImpl.paintFocus(g,b,paintViewR,paintTextR,paintIconR, Color.red);
    }
  }  
}
