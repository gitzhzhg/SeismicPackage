// JumpArraySetActionHandler.java
...
/**
 * Action handler for the "JumpArraySet" action.
 */
public class JumpArraySetActionHandler
   ...
   */
  public JumpArraySetActionHandler(AppGUIController.ActionHandlerHelper helper) {
    super(helper);  
  }
  ...
  public void performAction(Node n) {
    ...
    if (control != null) {
      ...
      //Console.logMessage("JumpArraySetActionHandler: Couldn't find component " + keyword);
    }
  }        
