 ...
 */
public class LeaveArrayActionHandler  extends GUIMessageHandlerAdapter {
  /**
   * Constructs a new action handler.
   */
  public LeaveArrayActionHandler() {
    super();  
  }
   ...
   *               adapter
   */
  public LeaveArrayActionHandler(CommController commController) {
  ...
  public void handleEvent(GUIControlEvent e) {
    ...
    getCommController().transmitMessage(e.getWindowId(), "LeaveArray", 
      src.getKeyword(), null);
  }  
}