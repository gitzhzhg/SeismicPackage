...
/**
 * Custom focus manager. Much of the code has been adapted from
 * Swing's default focus manager.
 */
public class ConocoFocusManager extends FocusManager {
   ...
   */
   ...
   public void processKeyEvent(Component focusedComponent,KeyEvent anEvent) {
    if( ((anEvent.getKeyChar() == 'i')  || (anEvent.getKeyCode() == KeyEvent.VK_I)) &&
      (focusedComponent instanceof JTable) ) {
        return;
    }
  ...
  public void focusPreviousComponent(Component aComponent) {
    ...
    private Component getFocusableComponentAfter(Component focusedComponent,
      ...
      while(!(nextComponent.isVisible() && 
                  ...
                  !(nextComponent instanceof JTableHeader) &&
                  !(nextComponent instanceof RowTable)  ));
