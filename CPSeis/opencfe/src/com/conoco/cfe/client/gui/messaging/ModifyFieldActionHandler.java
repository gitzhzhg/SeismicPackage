...
/**
 * An action handler for the "ModifyField" action.
 */
public class ModifyFieldActionHandler  extends GUIMessageHandlerAdapter {
  /**
   * Constructs a new action handler.
   */
  public ModifyFieldActionHandler() {
    super();  
  }
   ...
   */
  public ModifyFieldActionHandler(CommController commController) {
  ...
  public void handleEvent(GUIControlEvent e) {
    ...
    getCommController().transmitMessage(e.getWindowId(), "ModifyField", src.getKeyword(), value);
  }  
}