// BottomAreaButtonsActionHandler.java
 ...
 */
public class BottomAreaButtonsActionHandler
   ...
   */
  public BottomAreaButtonsActionHandler(AppGUIController.ActionHandlerHelper helper) {
    super(helper);  
  }
  ...
  public void performAction(Node n) {
    ...
    if (control != null) {
      ...
      //Console.logMessage("BottomAreaButtonsActionHandler: Couldn't find component " + keyword);
    }
  }        
}
