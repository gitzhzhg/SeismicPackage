...
/**
 * Action handler for the "BottomAreaButtons" action.
 */
public class SetMnemonicActionHandler
   ...
   */
  public SetMnemonicActionHandler(AppGUIController.ActionHandlerHelper helper) {
    super(helper);  
  }
  ...
  public void performAction(Node n) {
    ...
    ButtonControl bc = (ButtonControl) getHelper().getControl(pid, keyword);
        
    if (bc != null) {
      char shortcut = value.charAt(0);
      bc.setMnemonic(shortcut);
    }
    else {
      //Console.logMessage("setMnemonicActionHandler: Couldn't find component " + keyword);
    }
  }        
}
