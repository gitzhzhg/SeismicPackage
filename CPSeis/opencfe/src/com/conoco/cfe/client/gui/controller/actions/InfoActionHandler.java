...
/**
 * Action handler for the "Info" action.
 */
public class InfoActionHandler
   ...
   */
  public InfoActionHandler(AppGUIController.ActionHandlerHelper helper) {
    super(helper);  
  }
...
//SMCook window logic to get modal dialogs working properly (not accidentally hidden)
    ...
    if(f == null)
      ErrorInfoWarningDialog.showInfoDialog(messages);
    else
      ErrorInfoWarningDialog.showInfoDialog(messages,f);
  }        
}
