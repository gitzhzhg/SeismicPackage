// ItemsSelectedActionHandler.java
...
/**
 * An action handler for the "SelectionMade" action.
 */
public class ItemsSelectedActionHandler  extends GUIMessageHandlerAdapter {
  /**
   * Constructs a new action handler.
   */
  public ItemsSelectedActionHandler() {
    super();  
  }
   ...
   *               action listener
   */
  public ItemsSelectedActionHandler(CommController commController) {
  ...
  public void handleEvent(GUIControlEvent e) {
    ...
    // (ie it adds 1)
    getCommController().transmitMessage(e.getWindowId(), "ItemSelected", 
