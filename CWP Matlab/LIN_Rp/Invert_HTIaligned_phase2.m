...
% (this version is created for an HTI reflecting halfspace and ISO, VTI, 
% or HTI alligned incidence halfspace):
% 
...
%in_file='Result_exact_phase1.out';                                     % parameters

control=2;                           % type of the incidence halfspace:
                                     % 0 ... ISO
				     % 1 ... VTI
				     % 2 ... HTI alligned
...
switch control
 case 0
  VTI(0,AAp,BBp1,BBp2,AAs1,AAs2);
 case 1
  VTI(1,AAp,BBp1,BBp2,AAs1,AAs2);
 case 2
  VTI(2,AAp,BBp1,BBp2,AAs1,AAs2);
 otherwise
