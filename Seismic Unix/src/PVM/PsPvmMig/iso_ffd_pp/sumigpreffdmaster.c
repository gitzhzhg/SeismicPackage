...
/* SUMIGPREFDMASTER: $Revision: 1.2 $ ; $Date: 2011/11/21 16:49:25 $       */
...
"                                                                       ",
"lpad=9999,rpad=9999  zero traces padded on both sides of depth section",
" to determine the migration aperature, the default values are using the",
"full aperature.							",
NULL};
/**************** end self doc *******************************************/
