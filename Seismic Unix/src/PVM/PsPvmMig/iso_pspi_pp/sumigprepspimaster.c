...
/* SUMIGPREFDMASTER: $Vision: 1.00 $ ; $Date: 2011/11/21 16:48:39 $       */
...
char *sdoc[] = {
"									",
"SUPREMIGPSPIMASTER --- The master code of the 2-D prestack shot-gather",
"Usage:									",
"sumigprepspimaster <indata >outfile [parameters]			", 
"                                                                       ",
"Required Parameters:                                                   ",
"                                                                       ",
...
"                                                                       ",
"shift=0, the input data has not been shifted				",
"     =1, the input data has been shifted				",
"									",
  ...
  
{
	...
	if (!getparint("dip",&dip)) dip=65;
        if (!getparfloat("para",&para)) para = 0.1;
...
loop:
	...
	warn("shift=%d, ntw/2= %d", shift, ntw/2);
