...
/* buffPutc(buff, c)	
   ...
   buffMerge(buff1, buff2)
	...
	begining, returns 0 if successful, _WPC_EOB otherwise
...
#define buffWrite(buff, size, nitem, ptr)\
	(((buff)->pos + (size)*(nitem) > (buff)->mbound)? WPC_EOB :\
