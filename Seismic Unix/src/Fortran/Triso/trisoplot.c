...
char *sdoc[] = {
"	 								",
" TRISOPLOT - convert TRISOPLOT data to files for CWP graphers		",
" 									",
" trisoplot <triso1plot [optional parameter file]			",
" 									",
" Required parameters:							",
" 	none 								",
" 									",
...
/* trisoplot.c:(.text+0xe3): warning: the `gets' function is dangerous and should not be used. */
...
/* trisoplot.c:(.text+0x1e7): warning: the `gets' function is dangerous and should not be used. */
/* 			gets(buf); */
