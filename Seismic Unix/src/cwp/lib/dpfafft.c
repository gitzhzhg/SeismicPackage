...
int npfar_d (int nmin)
/*****************************************************************************
Return smallest valid n not less than nmin for real-to-real_complex or 
real_complex-to-real prime factor ffts.
******************************************************************************
Input:
nmin		lower bound on returned value
...
*****************************************************************************/
{
    return 2*npfa_d((nmin+1)/2);
}

int npfaro_d (int nmin, int nmax)
/*****************************************************************************
Return optimal n between nmin and nmax for real-to-real_complex or 
real_complex-to-real prime factor ffts
******************************************************************************
Input:
nmin		lower bound on returned value
...
*****************************************************************************/
{
    return 2*npfao_d((nmin+1)/2,(nmax+1)/2);
}

/* code for generating the next block of constants
int
main()
{

	fprintf(stdout,"%7s %4s %.20f\n","#define","P120",sin(1.0*PI/26.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P142",sin(1.0*PI/22.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P173",sin(1.0*PI/18.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P222",sin(1.0*PI/14.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P239",sin(1.0*PI/13.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P281",sin(1.0*PI/11.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P342",sin(1.0*PI/9.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P354",sin(3.0*PI/26.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P382",sin(1.0*PI/8.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P415",sin(3.0*PI/22.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P433",sin(1.0*PI/7.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P464",sin(2.0*PI/13.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P540",sin(2.0*PI/11.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P559",(1.0/4.0+sin(1.0*PI/10.0)));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P568",sin(5.0*PI/26.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P587",sin(1.0*PI/5.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P623",sin(3.0*PI/14.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P642",sin(2.0*PI/9.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P654",sin(5.0*PI/22.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P663",sin(3.0*PI/13.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P707",sin(1.0*PI/4.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P748",sin(7.0*PI/26.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P755",sin(3.0*PI/11.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P766",sin(5.0*PI/18.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P781",sin(2.0*PI/7.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P822",sin(4.0*PI/13.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P841",sin(7.0*PI/22.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P866",sin(1.0*PI/3.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P885",sin(9.0*PI/26.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P900",sin(5.0*PI/14.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P909",sin(4.0*PI/11.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P923",sin(3.0*PI/8.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P935",sin(5.0*PI/13.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P939",sin(7.0*PI/18.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P951",sin(2.0*PI/5.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P959",sin(9.0*PI/22.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P970",sin(11.0*PI/26.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P974",sin(3.0*PI/7.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P984",sin(4.0*PI/9.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P989",sin(5.0*PI/11.0));
	fprintf(stdout,"%7s %4s %.20f\n","#define","P992",sin(6.0*PI/13.0));
...
#define P120 0.12053668025532304764
#define P142 0.14231483827328514358
#define P173 0.17364817766693033119
#define P222 0.22252093395631439288
#define P239 0.23931566428755773890
#define P281 0.28173255684142967104
#define P342 0.34202014332566871291
#define P354 0.35460488704253562142
#define P382 0.38268343236508978178
#define P415 0.41541501300188637957
#define P433 0.43388373911755812040
#define P464 0.46472317204376850652
#define P540 0.54064081745559755543
#define P559 0.55901699437494745126
#define P568 0.56806474673115581187
#define P587 0.58778525229247313710
#define P623 0.62348980185873348336
#define P642 0.64278760968653925190
#define P654 0.65486073394528510061
#define P663 0.66312265824079519305
#define P707 0.70710678118654746172
#define P748 0.74851074817110108128
#define P755 0.75574957435425826890
#define P766 0.76604444311897801345
#define P781 0.78183148246802980363
#define P822 0.82298386589365635224
#define P841 0.84125353283118109449
#define P866 0.86602540378443859659
#define P885 0.88545602565320991051
#define P900 0.90096886790241914600
#define P909 0.90963199535451833011
#define P923 0.92387953251128673848
#define P935 0.93501624268541483342
#define P939 0.93969262078590831688
#define P951 0.95105651629515353118
#define P959 0.95949297361449736865
#define P970 0.97094181742605201180
#define P974 0.97492791218182361934
#define P984 0.98480775301220802032
#define P989 0.98982144188093268422
#define P992 0.99270887409805397272
#define NFAX 10

void pfacc_d (int isign, int n, real_complex cz[])
/*****************************************************************************
Prime factor fft:  real_complex to real_complex transform, in place
******************************************************************************
Input:
isign		sign of isign is the sign of exponent in fourier kernel
n		length of transform (see notes below)
...
void pfacr_d (int isign, int n, real_complex cz[], real rz[])
/*****************************************************************************
Prime factor fft:  real_complex to real transform
******************************************************************************
Input:
isign       sign of isign is the sign of exponent in fourier kernel
n           length of transform (see notes below)
...
*****************************************************************************/
{
    ...
    /* do real_complex to real_complex transform */
    pfacc_d(isign,n/2,(real_complex*)z);
}

void pfarc_d (int isign, int n, real rz[], real_complex cz[])
/*****************************************************************************
Prime factor fft:  real to real_complex transform
******************************************************************************
Input:
isign       sign of isign is the sign of exponent in fourier kernel
n           length of transform; must be even (see notes below)
...
void pfamcc_d (int isign, int n, int nt, int k, int kt, real_complex cz[])
/*****************************************************************************
Prime factor fft:  multiple real_complex to real_complex transforms, in place
******************************************************************************
Input:
isign       	sign of isign is the sign of exponent in fourier kernel
n           	number of real_complex elements per transform (see notes below)
...
void pfa2cc_d (int isign, int idim, int n1, int n2, real_complex cz[])
/*****************************************************************************
Prime factor fft:  2-D real_complex to real_complex transforms, in place
******************************************************************************
Input:
isign       	sign of isign is the sign of exponent in fourier kernel
idim        	dimension to transform, either 1 or 2 (see notes)
...
*****************************************************************************/
{
    ...
    /* do multiple real_complex to real_complex transforms */
    pfamcc_d(isign,n,nt,k,kt,cz);
}

void pfa2cr_d (int isign, int idim, int n1, int n2, real_complex cz[], real rz[])
/*****************************************************************************
Prime factor fft:  2-D real_complex to real transforms
******************************************************************************
Input:
isign       sign of isign is the sign of exponent in fourier kernel
idim        dimension to transform, which must be either 1 or 2 (see notes)
...
*****************************************************************************/
{
    ...
    if (idim==1) {
        ...
        /* transform as real_complex elements */
        pfa2cc_d(isign,1,n1/2,n2,(real_complex*)z);

    /* else, if transforming dimension 2 */
    } else {

        /* transform as real_complex elements */
        pfa2cc_d(isign,2,n1,n2/2,(real_complex*)z);
...
void pfa2rc_d (int isign, int idim, int n1, int n2, real rz[], real_complex cz[])
/*****************************************************************************
Prime factor fft:  2-D real to real_complex transforms
******************************************************************************
Input:
isign       sign of isign is the sign of exponent in fourier kernel
idim        dimension to transform, which must be either 1 or 2 (see notes)
