...
**	the internal Sfdouble_t representation. This code is not aware
**	of the alternative decimal/thousand characters. It is assumed
**	that whoever calls it should have done the necessary massaging.
**
