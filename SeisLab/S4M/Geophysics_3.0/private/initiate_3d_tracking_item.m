function initiate_3d_tracking_item(options_menu_handle,matrix,x,y,xinfo,yinfo,zinfo,bool,axis_handle)
...
if isempty(bool)
   ...
   if isempty(handle)
      create_menu_item4tracking({@display_cursor_location_3d},options_menu_handle);
   end
else
  if bool
     create_menu_item4tracking(@display_cursor_location_3d,options_menu_handle);
