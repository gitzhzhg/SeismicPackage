...
try
    ...
    if ~isa(obj,'TraceHeader')
        me=MException('viewfloatingpointtypes:InvalidInputType',...
    ...
    maxnumoftraces=length(obj.traceoffsets)-1;
    ...
    dt=double(getheadervalue(obj,'dt'));
    nsamp=double(getheadervalue(obj,'ns'));
    ...
    function plothistograms(hObject, ~)
        ...
        obj.tracetype={4,'float32'};obj.filefmt='L';obj.machineformat='ieee-le';
        h.tracieeel=getTraces(obj,'tracenumber',1:h.numoftraces);
        ...
        obj.tracetype={4,'real*4'};obj.filefmt='B';obj.machineformat='ieee-be';
        h.tracieeeb=getTraces(obj,'tracenumber',1:h.numoftraces);
        ...
        obj.tracetype={4,'ibm'};obj.filefmt='L';obj.machineformat='ieee-le';
        h.tracibml=getTraces(obj,'tracenumber',1:h.numoftraces);
        ...
        obj.tracetype={4,'ibm'};obj.filefmt='B';obj.machineformat='ieee-be';
        h.tracibmb=getTraces(obj,'tracenumber',1:h.numoftraces);
