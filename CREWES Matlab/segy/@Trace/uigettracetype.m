...
try
    ...
    set(h.ieeelplot,'parent',h.buttonpan);
    set(h.ieeebplot,'parent',h.buttonpan);
    set(h.ibmlplot,'parent',h.buttonpan);
    set(h.ibmbplot,'parent',h.buttonpan);
    set(h.traceplot,'parent',h.buttonpan);
